...
@endif -->
    ...
    <div class="container-fluid px-3">
        ...
        <form id="locationForm" method="post" action="{{ route('location-selected-admin') }}">
            @csrf
            <div class="row mb-3">
                <label class="form-label col-md-6 col-sm-12 col-lg-6">Select Hotel</label>
    ...
    <div class="container-fluid px-3" id="search-results">
        ...
        @else
            <div class="border-box mb-4" id="search-results">
                <!-- Header Title -->
                <div class="grid-header text-center">
                    <h6 class="m-0 text-white">Please Select Hotel First</h6>
                </div>
            </div>
        @endif
    </div>
    ...
    <div id="addPopup" class="popup-container">
        <div class="popup-content">
            <form class="forms-sample" id="frm_register_add" name="frm_register" method="post" role="form"
                ...
                <hr />
                <div class="row mb-3">
                    <label class="col-md-6 col-sm-12 col-lg-6 form-label">Select Hotel</label>
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <select class="form-select select2" name="hotel_id" data-placeholder="Select Hotel"
                            id="locationSelect">
                            <option value="">Select Hotel</option>
        ...
        <div class="popup-content">
            <form class="forms-sample" id="frm_copy_inventory" name="frm_copy_inventory" method="post"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <select class="form-select select2" name="from_location_id"
                            data-placeholder="Select Hotel" id="FromLocationId">
                            <option value="">Select Hotel</option>
                            @foreach ($locationsData as $locationItem)
                                <option value="{{ $locationItem['id'] }}">{{ $locationItem['hotel_name'] }}</option>
                            @endforeach
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <select class="form-select select2" name="to_location_id" data-placeholder="Select Hotel"
                            id="ToLocationId">
                            <option value="">Select Hotel</option>
                            @foreach ($locationsData as $locationItem)
                                <option value="{{ $locationItem['id'] }}">{{ $locationItem['hotel_name'] }}</option>
            ...
            $(document).on('click', '.edit-btn-item', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#hotel_id').val(response.user_data.hotel_id);
    ...
    <script>
        $(document).ready(function() {
            ...
            // console.log(originalData, "originalDataoriginalDataoriginalDataoriginalData");
            
            // Bind keyup event to the search input
            $('#search-query').on('keyup', function() {
                showLoader();
                var query = $(this).val().trim(); // Get the value entered in the search box
                // console.log(query, "responseresponseresponseresponseresponseresponse");
                if (query.length > 0) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.length > 0) {
                                ...
                                // Clear the previous results
                                $('#search-results').html('No Data Found sfsdfsdf');
                                hideLoader();
                            }
